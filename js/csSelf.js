...
Vue.component('cssart-layout', {
    template: `<div class="csS-art__card">
                ...
                <p>因感情問題來看診的年輕女性，有這四個共同特點</p>
                <p class="small">不管對男生、女生來說，失去身邊親愛的人絕對是很大的打擊，其實跟年紀也不一定有關係。我有一個50多歲的病人，陷入一場瘋狂的戀愛，所有的理智都沒用，憂鬱了好幾個月。</p>
                ...
                <div class="card-share">
                    <span>Share : </span>
                    <a href="" class="" class="small"><img src="img//icon//facebook.png" alt=""></a>
                    <a href="" class="" class="small"><img src="img//icon//share.png" alt=""></a>
                    <a href="" class="" class="small"><img src="img//icon//bookmark.png" alt=""></a>
                </div>
</div>`,
})
